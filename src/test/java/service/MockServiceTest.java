...
public class MockServiceTest {
    ...
    public void shouldExeptionWhenSetNameYasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void confirmListSizeCheck(){
    ...
    @Test
    public void shouldUnderThreeTimesInvocationForGetChampionName(){
        Champion champion = mock(Champion.class);
        champion.setName("야스오");
        champion.setPosition("미드");
        champion.setHasSkinCount(6);
    ...
    @Test
    public void shouldNotInvoationForSetChampionName(){
        Champion champion = mock(Champion.class);
        //champion.setName("야스오");
        champion.setPosition("미드");
        champion.setHasSkinCount(6);
    ...
    @Test
    public void periodicalInvocationForGetName() {
        Champion champion = mock(Champion.class);
        champion.setName("야스오");
        champion.setPosition("미드");
        champion.setHasSkinCount(6);
        ...
        verify(champion, timeout(200).atLeast(1)).setName(anyString());
    }
    ...
    @Test
    public void searchAndCheckPosition(){
        when(mockService.findByName(("리산드라"))).thenReturn(new Champion("리산드라", "미드", 2));
    ...
    public void testConfirmCountWhenGetChampionList(){
        ...
        champions.add(new Champion("루시안", "바텀",1));
        champions.add(new Champion("유미", "바텀",2));
        champions.add(new Champion("애쉬", "바텀",3));
    ...
    @Test
    public void testConfirmSkinWhenGetChampion(){
        when(mockService.findByName((anyString()))).thenReturn(new Champion("애쉬", "바텀",3));
